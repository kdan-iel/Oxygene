...
const GalleryPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      <DynamicHero
        title={language === 'fr' ? "Galerie avant/après" : "Before/after gallery"}
        subtitle={language === 'fr' ? "Découvrez nos réalisations" : "Discover our achievements"}
        ...
        height="h-[60vh]"
        showCTA={true}
        ctaText={language === 'fr' ? "Demander un devis" : "Request a quote"}
      />
